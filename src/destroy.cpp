...
bool destroy::destroy_files(const std::vector<std::pair<std::string, std::string>> &files_to_delete) {
    std::cout << "\033[31mFor now instead of doing destructive operations we will just be renaming files suffixed with "
